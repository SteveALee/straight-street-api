...
$config['SITE_PATH'] = realpath('..').'/api/';
//$config['PROTECTED_FOLDER'] = 'protected/';
$config['BASE_PATH'] = realpath('..').'/doophp/dooframework/';
//$config['BASE_PATH'] = realpath('..').'/dooframework/';

//for production mode use 'prod'
$config['APP_MODE'] = 'dev'; // NOTE seems to effect view tmeplate compilation
...
*/
$config['SUBFOLDER'] = '/api/';

$config['APP_URL'] = 'http://'.$_SERVER['HTTP_HOST'].$config['SUBFOLDER'];

//$config['AUTOROUTE'] = TRUE;
$config['DEBUG_ENABLED'] = TRUE; // Note seems to effect DooLog()
